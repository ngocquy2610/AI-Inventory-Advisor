"""Legacy OverstockService — kept for backward compatibility of the /detect endpoint.

Will be removed once the M4 batch pipeline is fully wired and the old
/detect endpoint is decommissioned.
"""
